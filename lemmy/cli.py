...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="lemmy",
        description="Terminal chatbot for interacting with LLMs via LM Studio. Supports customization of model, persona, and response parameters to tailor the chat experience.",
    )
    ...
    parser.add_argument(
        ...
        "--api-base",
        type=str,
        help="Override LM Studio API base URL",
    )
    parser.add_argument(
        "-t",
        "--temperature",
    ...
    # API base override
    if args.api_base:
        app.console.print(f"Using API base: {args.api_base}", style="dodger_blue3")
        app.client = OpenAIClient(args.api_base)
